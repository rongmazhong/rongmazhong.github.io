...
layout:       post
title:        "创建第一篇博客"
subtitle:     "透彻的掌握 Spring 中@transactional 的使用"
...
![Spring 事务实现机制](/img/in-post/post-incloud/spring事务实现机制.jpg)
...
![TransactionManager 类结构](/img/in-post/post-incloud/TransactionManager 类结构.jpg)
